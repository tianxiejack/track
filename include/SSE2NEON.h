...
//	return (__m128)veorq_s32((__m128i)*pa, (__m128i)*pb);
}
...
FORCE_INLINE __m128 _mm_shuffle_ps_default(__m128 a, __m128 b, int i)
{
...
FORCE_INLINE __m128 _mm_shuffle_ps_function(__m128 a, __m128 b, int i )
{
	switch (i)
	{
		...
		default:	return _mm_shuffle_ps_default(a, b,i);
	}
}
#define _mm_shuffle_ps(a,b,i) _mm_shuffle_ps_function(a,b, i)
...
{
	__m128 e = vrsqrteq_f32(in);
	e = vmulq_f32(e, vrsqrtsq_f32(in, vmulq_f32(e, e)));
	e = vmulq_f32(e, vrsqrtsq_f32(in, vmulq_f32(e, e)));
	return e;
}
